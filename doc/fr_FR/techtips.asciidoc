...
Le clavier a code utilise le protocole Wiegand 8bits. Il envoi le code des touches une par une. C'est donc l'Arduino qui va gérer cette saisie et envoyer le code complet à Jeedom.
